...
import { formatPrice, buildWhatsAppUrl, buildWhatsAppMessage, buildEmailBody, getLocalizedField, DELIVERY_FEE } from "@/lib/utils";
...
const ORDER_EMAIL = "Munisadolieva0@gmail.com";
...
export function CartDrawer({ isOpen, onClose }: CartDrawerProps) {
  ...
  const handleWhatsApp = () => {
    const message = buildWhatsAppMessage(getOrderItems(), total, "GBP");
    const phone = process.env.NEXT_PUBLIC_WHATSAPP || "+447775777313";
    const url = buildWhatsAppUrl(phone, message);
    window.open(url, "_blank");
  };

  const emailBody = buildEmailBody(getOrderItems(), total, "GBP");
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="font-medium text-gray-900 text-sm line-clamp-2">{name}</p>
                          {item.selectedSize && (
              ...
              <div className="border-t border-gray-100 p-6 space-y-4">
                ...
                <div className="space-y-2">
                  <button
                    ...
                    className="w-full py-3.5 bg-[#25D366] hover:bg-[#20BA5A] text-white font-semibold rounded-2xl flex items-center justify-center gap-3 transition-colors shadow-lg shadow-green-200"
                  >
                  ...
                  <button
                    ...
                    className="w-full py-3.5 bg-gray-900 hover:bg-gray-800 text-white font-semibold rounded-2xl flex items-center justify-center gap-3 transition-colors"
                  >
