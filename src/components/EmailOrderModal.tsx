              ...
              <div className="space-y-2 pb-2">
                <div className="grid grid-cols-2 gap-3">
                  <a
                    ...
                    className="flex items-center justify-center gap-2 py-3 rounded-xl font-semibold text-sm text-white transition-colors hover:opacity-90"
                ...
                <a
                  href={mailtoUrl}
                  className="w-full flex items-center justify-center gap-2 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-xl text-sm font-medium transition-colors"
                >
